...
const CarCard = ({car}) => {
    ...
    return (
    <div onClick={() => {router.push(`/car-details/${car._id}`); scrollTo(0,0)}} className='group rounded-xl overflow-hidden shadow-lg hover:-translate-y-1 transition-all duration-500 cursor-pointer' >
        
        <div className='relative h-48 overflow-hidden'>
            <Image src={car.image} alt='car Image ' width={300} height={300} className='w-full h-full object-cover transition-transform 
        ...
        <div className='p-4 sm:p-5'>
            ...
            <div className='mt-4 grid grid-cols-2 gap-y-2 text-gray-600'>
                <div className='flex items-center text-sm text-muted-foreground'>
                    <Image src={assets.users_icon} alt='' className='h-4 mr-2' />
